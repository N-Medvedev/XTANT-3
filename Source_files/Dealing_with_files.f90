...
subroutine Count_lines_in_file(File_num, N, skip_lines, skip_empty, skip_comment)
    ...
    if (present(skip_comment)) then
       comment = skip_comment(1:1)  ! first character is the comment
    endif
